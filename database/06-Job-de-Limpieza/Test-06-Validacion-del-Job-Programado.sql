...
BEGIN
    ...
    -- Creamos un QR con una fecha de creación de hace 9 horas
    INSERT INTO SESIONES_CLASE_QR (ID_CURSO_IMPARTIDO_FK, CODIGO_QR, FECHA_CREACION, ESTADO)
    VALUES (v_id_curso_impartido, 'QR-TEST-ANTIGUO-12345', (SYSTIMESTAMP - INTERVAL '24' HOUR), 'A');
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('-> Se ha creado un QR de prueba antiguo con ESTADO = ''A''.');
END;
/
