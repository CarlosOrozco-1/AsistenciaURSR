...
-- -- Versión: 3.0 (Añade permiso SELECT faltante para ROL_CATEDRATICO)
-- --
...
-- **NUEVO** Permiso para que el catedrático pueda ver los cursos impartidos
GRANT SELECT ON CURSOS_IMPARTIDOS TO ROL_CATEDRATICO;

-- Permisos para ROL_ADMINISTRATIVO
